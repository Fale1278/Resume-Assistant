        ...
        <div className=' flex gap-[2rem]'>
          <div>
            <div className='App h-20 bg-black flex justify-center items-center'>
              <label className='relative'>
                <input type="email" className='h-[50px] w-[375px] px-6 text-[15px] bg-black border-2 border=white border-opacity-50 outline-none focus:border-blue-500 focus:text-white tramsiton duration-200'/>
            ...
            <div className='App h-20 bg-black flex justify-center items-center'>
            <label className='relative'>
              <input type="text" className='h-[50px] w-[375px] px-6 text-[15px] bg-black border-2 border=white border-opacity-50 outline-none focus:border-blue-500 focus:text-white tramsiton duration-200'/>
          ...
          <div>
            <div className=' flex justify-between items-center'>
              ...
              <div className='App h-20 bg-black flex justify-center items-center'>
              <label className='relative'>
                <input type="number" className='h-[50px] w-[375px] px-6 text-[15px] bg-black border-2 border=white border-opacity-50 outline-none focus:border-blue-500 focus:text-white tramsiton duration-200'/>
          ...
          <div className='App  bg-black flex justify-center items-center'>
            <label className='relative'>
              <input type="text" className='h-[200px] w-[674px] px-6 text-[15px] bg-black border-2 border=white border-opacity-50 outline-none focus:border-blue-500 focus:text-white tramsiton duration-200'/>
